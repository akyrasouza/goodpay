    ...
    {idModal: "camposVazios1",
     ...
     bodyModal: "Os campos não podem estar vazios!",
      ...
      {idModal: "usuarioNaoExiste1",
       ...
       bodyModal: "Não é possível logar o usuário solicitado!",
      b1: "Fechar", b2:"Criar"},
      ...
      b1: "Fechar", b2:"GoodPay Home"},
      {idModal: "falhaLogin1", 
      title: "Não foi possivel logar", 
      bodyModal: "Erro nas informações dados ao sistema GoodPay",
      b1: "Fechar", b2:"Esqueci a senha"}
];
